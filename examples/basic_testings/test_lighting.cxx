...
// void simple_cb(EVENT evt,Pos pos,EVENT_PARM parameter){spdlog::info("call on:{}",(int)evt);exit(-2);}
...
class MyWindow:public Window{
    ...
    Window()
    {
        ...
        vsizer->add(h1,1);
        vsizer->add(world,4);
        auto f=[t1](EVENT evt,Pos pos,EVENT_PARM parameter){t1->repr();exit(-1);};
        h1->add(t1,1);
        h1->add(t2,2);
